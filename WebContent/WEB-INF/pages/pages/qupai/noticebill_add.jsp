...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<div region="center" style="overflow:auto;padding:5px;" border="false">
		<form id="noticebillForm" action="${pageContext.request.contextPath }/noticebillAction_add.action"
			 method="post">
			<table class="table-edit" width="100%" align="center">
				...
				<tr>
					<td>取件地址</td>
					<td colspan="3"><input required="true" type="text" class="easyui-validatebox" name="pickaddress"
						 size="144"/></td>
				</tr>
				<tr>
					<td>到达城市:</td>
